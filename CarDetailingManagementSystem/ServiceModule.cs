    ...
    public partial class ServiceModule : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cm = new SqlCommand("INSERT INTO tbService(ServiceName,ServicePrice)VALUES(@name,@price)", dbcon.connect());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cm = new SqlCommand("UPDATE tbService SET ServiceName=@name, ServicePrice=@price WHERE ServiceId=@id", dbcon.connect());
